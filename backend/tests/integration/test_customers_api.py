...
class TestCustomerList:
    ...
    def test_list_customers_success(
        self, client, mock_supabase, mock_customer_service, auth_headers
    ):
        ...
        mock_supabase.from_.return_value.select.return_value.order.return_value.range.return_value.execute.return_value.data = (
            customers
        )
    ...
    def test_list_customers_with_filters(self, client, mock_supabase, auth_headers):
        ...
        response = client.get(
            "/api/customers/?city=Birmingham&min_lifetime_value=50000", headers=auth_headers
        )
    ...
    def test_list_customers_pagination(self, client, mock_supabase, auth_headers):
        ...
        mock_supabase.from_().select.return_value.range.return_value.execute.return_value.data = (
            customers
        )
...
class TestGetCustomer:
    ...
    def test_get_customer_success(self, client, mock_supabase, auth_headers, sample_customer):
        ...
        mock_supabase.from_().select.return_value.eq.return_value.single.return_value.execute.return_value.data = (
            sample_customer
        )
    ...
    def test_get_customer_with_history(self, client, mock_supabase, auth_headers, sample_customer):
        ...
        mock_supabase.from_().select.return_value.eq.return_value.order.return_value.limit.return_value.execute.return_value.data = (
            interactions
        )

        response = client.get(
            f'/api/customers/{sample_customer["id"]}?include_history=true', headers=auth_headers
        )
...
class TestCreateCustomer:
    ...
    def test_create_customer_success(self, client, mock_supabase, auth_headers, mock_pusher):
        ...
        response = client.post(
            "/api/customers/", headers=auth_headers, data=json.dumps(new_customer)
        )
    ...
    def test_create_customer_from_lead(self, client, mock_supabase, auth_headers):
        ...
        response = client.post("/api/customers/", headers=auth_headers, data=json.dumps(lead_data))
    ...
    def test_create_customer_invalid_data(self, client, auth_headers):
        ...
        invalid_customer = {"first_name": "NoEmail", "phone": "invalid_phone"}

        response = client.post(
            "/api/customers/", headers=auth_headers, data=json.dumps(invalid_customer)
        )
...
class TestUpdateCustomer:
    ...
    def test_update_customer_success(self, client, mock_supabase, auth_headers, mock_pusher):
        ...
        customer_id = str(uuid4())
        updates = {"phone": "2485551111", "nps_score": 10}
        ...
        response = client.put(
            f"/api/customers/{customer_id}", headers=auth_headers, data=json.dumps(updates)
        )
...
class TestCustomerInteractions:
    ...
    def test_get_customer_interactions(self, client, mock_supabase, auth_headers):
        ...
        interactions = [
            ...
            {"id": str(uuid4()), "type": "email", "date": "2024-01-18", "notes": "Sent quote"},
        ]

        mock_supabase.from_().select.return_value.eq.return_value.order.return_value.execute.return_value.data = (
            interactions
        )
    ...
    def test_create_customer_interaction(self, client, mock_supabase, auth_headers, mock_pusher):
        ...
        customer_id = str(uuid4())
        interaction = {"type": "email", "notes": "Follow-up on quote", "outcome": "positive"}
...
class TestCustomerLifetimeValue:
    ...
    def test_calculate_lifetime_value(self, client, mock_supabase, auth_headers):
        ...
        response = client.post(f"/api/customers/{customer_id}/calculate-ltv", headers=auth_headers)
...
class TestCustomerStats:
    ...
    def test_get_customer_stats(self, client, mock_supabase, auth_headers):
        ...
        mock_supabase.from_().select.return_value.execute.return_value.data = [{"count": 500}]
...
class TestBulkOperations:
    ...
    def test_bulk_update_customers(self, client, mock_supabase, auth_headers):
        ...
        updates = {
            ...
            "updates": {"campaign": "spring_2024", "segment": "premium"},
        }
        ...
        response = client.post(
            "/api/customers/bulk-update", headers=auth_headers, data=json.dumps(updates)
        )
    ...
    def test_export_customers(self, client, mock_supabase, auth_headers):
        ...
        response = client.get("/api/customers/export?format=csv", headers=auth_headers)
