"""
iSwitch Roofs CRM - Customer Pydantic Schemas
Version: 1.0.0

Pydantic validation schemas for Customer API operations
"""
...
class CustomerStatus(str, Enum):
    """Customer status enumeration for API"""
...
class CustomerSegment(str, Enum):
    """Customer segment classification for API"""
...
class Customer(CustomerBase):
    """
    Complete customer schema with all fields (for responses)
    """
