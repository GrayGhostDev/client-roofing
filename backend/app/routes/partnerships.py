...
def list_partners():
    ...
    try:
        ...
        return jsonify({
            'success': True,
            'partners': partners_with_metrics,
...
def create_partner():
    ...
    try:
        ...
        if success:
            ...
            return jsonify({
                'success': False,
                'error': error or 'Failed to create partner'
            }), 400
...
def get_partner(partner_id):
    ...
    try:
        ...
        if success:
            ...
            return jsonify({
                'success': False,
                'error': error or 'Partner not found'
            }), 404
...
def update_partner(partner_id):
    ...
    try:
        ...
        if success:
            ...
            return jsonify({
                'success': False,
                'error': error or 'Failed to update partner'
            }), 404
...
def deactivate_partner(partner_id):
    ...
    try:
        success, error = partnerships_service.update_partner(
            partner_id,
            {'status': 'inactive', 'deactivated_at': datetime.utcnow().isoformat()}
        )
...
def create_referral():
    ...
    try:
        ...
        if success:
            ...
            return jsonify({
                'success': False,
                'error': error or 'Failed to create referral'
            }), 400
...
def update_referral_status(referral_id):
    ...
    try:
        ...
        if success:
            ...
            return jsonify({
                'success': False,
                'error': error or 'Failed to update referral'
            }), 400
...
def process_commission():
    ...
    try:
        ...
        if success:
            ...
            return jsonify({
                'success': False,
                'error': error or 'Failed to process commission'
            }), 400
...
def complete_payment(payment_id):
    ...
    try:
        ...
        success, error = partnerships_service.mark_payment_complete(
            payment_id,
            transaction_id
        )
        ...
        if success:
            ...
            return jsonify({
                'success': False,
                'error': error or 'Payment not found'
            }), 404
...
def get_partner_dashboard(partner_id):
    ...
    try:
        ...
        if success:
            ...
            return jsonify({
                'success': False,
                'error': error or 'Dashboard not available'
            }), 404
...
def get_partnerships_analytics():
    ...
    try:
        ...
        if success:
            ...
            return jsonify({
                'success': False,
                'error': error or 'Failed to generate analytics'
            }), 500
...
def get_partner_categories():
    ...
    try:
        return jsonify({
            'success': True,
            'categories': partnerships_service.partner_categories
        }), 200
