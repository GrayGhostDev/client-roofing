...
def alert_settings():
    ...
    try:
        ...
        if request.method == 'GET':
            ...
            result = supabase.table('alert_settings').select('*').eq('user_id', user['id']).execute()
...
def alert_performance_dashboard():
    ...
    try:
        ...
        dashboard_data = {
            ...
            'best_performer': metrics.get('team_leaderboard', [{}])[0] if metrics.get('team_leaderboard') else None,
