...
from flask import Blueprint, request, jsonify, g, redirect, url_for, session
...
from app.utils.validators import validate_datetime_format
...
def update_appointment(appointment_id: str):
    ...
    try:
        ...
        if 'scheduled_time' in data:
            try:
                data['scheduled_start'] = datetime.fromisoformat(data.pop('scheduled_time')).isoformat()
            except (ValueError, TypeError):
